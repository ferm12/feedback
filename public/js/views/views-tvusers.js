...
App.Views.AddClient = Backbone.View.extend({
	...
	initialize: function () {
        ...
        this.video_id               = this.form.find('#video_id');
	},
	...
	addClient: function (e) {
        ...
        // if (!this.password_unencrypted.val())
        //     var password_unencrypted = 'feedback';
        // if (!this.email.val())
        //     var email = this.username.val()+'@transvideo.com';
		...
		this.collection.create({
			...
			email:                  that.email.val() ? that.email.val() : this.username.val()+'@transvideo.com',
			password_unencrypted:   that.password_unencrypted.val() ? that.password_unencrypted.val() : 'feedback',
...
App.Views.Clients = Backbone.View.extend({
	...
	addOne: function (client) {
		...
		console.log(clientView.render().el );
